...
%         0, 0, 0, 0, 0, c66];
rho0 = 1570; % kg/m3
c11 = 12.8e9; % calculated from slowest qL velocity
c44 = c11*0.8; % calculated from fastest qS velocity
c33 = c11*4.06; % calculated from fastest qL velocity
c66 = c11*0.2;
c12 = c11-2*c66;
c13 = c11*0.082;
C0 = [c11, c12, c13, 0, 0, 0
...
u_n_width_sweep = [];
source_width_list = [0,0.1e-3,0.15e-3,0.2e-3,0.25e-3];
for ii = 1:length(source_width_list)
    source_width = source_width_list(ii);
frequency = 1.5e6; % Hz
in_wave = 2; % 1: qS1, 2:qS2, 3:qL
...
% source_width = 0.2e-3; % unit: metres
%%%%%%%%%%%%%%%%%%%%%%%%%% End of inputs %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
u_n_width_sweep = [u_n_width_sweep, u_n];
end
